<template>
    <section id="experienceSection" class="experience" data-aos-easing="ease-in-out" data-aos="fade-up"
        ...
        <p class="experience__phrase">2012 habe ich mein Grafik-Design-Studium erfolgreich abgeschlossen, danach habe ich mehr als fünf Jahre in verschiedenen Digitalagenturen gearbeitet. Ich begann meine Karriere mit Verpackungsdesign, Fotografie, Corporate Identity und Logodesign.</p>
